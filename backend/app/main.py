...
from app.api import auth, bonds, quotes, trades, futures, swaps, dashboard, favorites, admin, calendar, user, rating_changes
...
app.include_router(rating_changes.router)
